...
int main( int argc, char* argv[])
{
  ...
  vec ch_imp_response_real = "1.0  0.079432 0.063095";//randray( ch_nb_taps);
  ...
  dist_1 = 50;                  //Distance form transmitter to receiver 1 (meter)
  dist_2 = 100;                  //                   *                  2
  ...
  for (i = 0; i < alpha.length(); i++) {
    ...
    ofdm_symbols_1 = concat(ofdm_symbols_1, zeros_c(4));
